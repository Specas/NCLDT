...
eta={}; mu={}; eta_size={}; mu_size={};  m={}; q_root={}; q_target ={}; q_pivot={};
...
for i=1:num_trees
    createNewTree(q_start,q_end, alpha_init,epsilon_max_init,epsilon_min_init,m_init,rho_init,obstacle_coords, ndim, lim);
end
